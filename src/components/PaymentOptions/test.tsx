...
describe('<PaymentOptions />', () => {
  ...
  it('shoud handle select card when clicking on the label', async () => {
    render(<PaymentOptions cards={cards} handlePayment={jest.fn} />);
  ...
  it('shoud not call handlePayment when button is disabled ', () => {
  ...
  it('shoud call handlePayment when credit card is selected ', async () => {
    const handlePayment = jest.fn();
